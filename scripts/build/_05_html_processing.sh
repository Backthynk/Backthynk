...
JS_BUNDLE_PATH="/static/js/compressed/bundle.js"
CSS_BUNDLE_PATH="/static/css/compressed/bundle.css"
JS_START_TAG=$(get_html_processing_config "js_script_tags_start")
JS_END_TAG=$(get_html_processing_config "js_script_tags_end")
TAILWIND_CDN_PATTERN=$(get_html_processing_config "tailwind_cdn_pattern")
FONTAWESOME_CDN_PATTERN=$(get_html_processing_config "fontawesome_cdn_pattern")
